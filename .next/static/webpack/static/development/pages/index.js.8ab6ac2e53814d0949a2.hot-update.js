...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Container, [{
    ...
    value: function changeColor(e) {
      ...
      this.setState({
        color: ["rgba(".concat(color[0], ", ").concat(color[1], ", ").concat(color[2], ",.3"), "rgba(".concat(e.target.value, ",.8)"), e.target.value]
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.8ab6ac2e53814d0949a2.hot-update.js.map